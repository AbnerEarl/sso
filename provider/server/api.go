...
import (
	...
	"errors"
	"fmt"
	"github.com/AbnerEarl/sso/provider/api"

	"golang.org/x/crypto/bcrypt"

	"github.com/AbnerEarl/sso/provider/pkg/log"
	"github.com/AbnerEarl/sso/provider/server/internal"
...
const (
	...
	// load on a provider server.
	upBoundCost = 16
)

// NewAPI returns a server which implements the gRPC API interface.
func NewAPI(s storage.Storage, logger log.Logger, version string) api.ProviderServer {
	return providerAPI{
		s:       s,
		logger:  logger,
		version: version,
...
func (d providerAPI) GetClient(ctx context.Context, req *api.GetClientReq) (*api.GetClientResp, error) {
...
func (d providerAPI) CreateClient(ctx context.Context, req *api.CreateClientReq) (*api.CreateClientResp, error) {
	if req.Client == nil {
...
func (d providerAPI) UpdateClient(ctx context.Context, req *api.UpdateClientReq) (*api.UpdateClientResp, error) {
	if req.Id == "" {
...
func (d providerAPI) DeleteClient(ctx context.Context, req *api.DeleteClientReq) (*api.DeleteClientResp, error) {
...
func (d providerAPI) CreatePassword(ctx context.Context, req *api.CreatePasswordReq) (*api.CreatePasswordResp, error) {
	if req.Password == nil {
...
func (d providerAPI) UpdatePassword(ctx context.Context, req *api.UpdatePasswordReq) (*api.UpdatePasswordResp, error) {
	if req.Email == "" {
...
func (d providerAPI) DeletePassword(ctx context.Context, req *api.DeletePasswordReq) (*api.DeletePasswordResp, error) {
	if req.Email == "" {
		return nil, errors.New("no email supplied")
	}
...
func (d providerAPI) GetVersion(ctx context.Context, req *api.VersionReq) (*api.VersionResp, error) {
...
func (d providerAPI) ListPasswords(ctx context.Context, req *api.ListPasswordReq) (*api.ListPasswordResp, error) {
...
func (d providerAPI) VerifyPassword(ctx context.Context, req *api.VerifyPasswordReq) (*api.VerifyPasswordResp, error) {
	if req.Email == "" {
		return nil, errors.New("no email supplied")
	}
...
func (d providerAPI) ListRefresh(ctx context.Context, req *api.ListRefreshReq) (*api.ListRefreshResp, error) {
...
func (d providerAPI) RevokeRefresh(ctx context.Context, req *api.RevokeRefreshReq) (*api.RevokeRefreshResp, error) {
	id := new(internal.IDTokenSubject)
	if err := internal.Unmarshal(req.UserId, id); err != nil {
		d.logger.Errorf("api: failed to unmarshal ID Token subject: %v", err)
		return nil, err
