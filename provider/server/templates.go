...
//
// eg
// server listens at localhost/provider so serverPath is provider
// reqPath is /provider/auth
// assetPath is static/main.css
// relativeURL("/provider", "/provider/auth", "static/main.css") = "../static/main.css"
...
var scopeDescriptions = map[string]string{
	...
	// 'groups' is not a standard OIDC scope, and provider only returns groups only if the upstream provider does too.
