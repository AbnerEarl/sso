...
import (
	...
	"github.com/AbnerEarl/sso/provider/connector"
	"github.com/AbnerEarl/sso/provider/connector/atlassiancrowd"
	"github.com/AbnerEarl/sso/provider/connector/authproxy"
	"github.com/AbnerEarl/sso/provider/connector/bitbucketcloud"
	"github.com/AbnerEarl/sso/provider/connector/gitea"
	"github.com/AbnerEarl/sso/provider/connector/github"
	"github.com/AbnerEarl/sso/provider/connector/gitlab"
	"github.com/AbnerEarl/sso/provider/connector/google"
	"github.com/AbnerEarl/sso/provider/connector/keystone"
	"github.com/AbnerEarl/sso/provider/connector/ldap"
	"github.com/AbnerEarl/sso/provider/connector/linkedin"
	"github.com/AbnerEarl/sso/provider/connector/microsoft"
	"github.com/AbnerEarl/sso/provider/connector/mock"
	"github.com/AbnerEarl/sso/provider/connector/oauth"
	"github.com/AbnerEarl/sso/provider/connector/oidc"
	"github.com/AbnerEarl/sso/provider/connector/openshift"
	"github.com/AbnerEarl/sso/provider/connector/saml"
	"github.com/AbnerEarl/sso/provider/pkg/log"
	"github.com/AbnerEarl/sso/provider/storage"
	"github.com/AbnerEarl/sso/provider/web"
)
...
type WebConfig struct {
	...
	//   * templates - HTML templates controlled by Provider.
	...
	// Defaults to "( issuer URL )/theme/logo.gif"
	LogoURL string
...
func (db passwordDB) Login(ctx context.Context, s connector.Scopes, email, password string) (connector.Identity, bool, error) {
	...
	// This check prevents provider users from logging in using static passwords
