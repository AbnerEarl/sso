...
func signatureAlgorithm(jwk *jose.JSONWebKey) (alg jose.SignatureAlgorithm, err error) {
	...
	case *rsa.PrivateKey:
		...
		//
		// See https://github.com/AbnerEarl/sso/provider/issues/692
...
func (s *Server) parseAuthorizationRequest(r *http.Request) (*storage.AuthRequest, error) {
	...
	// provider doesn't support request parameter and must return request_not_supported error
...
// storageKeySet implements the oidc.KeySet interface backed by provider storage
