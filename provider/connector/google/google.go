...
import (
	...
	pkg_groups "github.com/AbnerEarl/sso/provider/pkg/groups"
...
func (c *Config) Open(id string, logger log.Logger) (conn connector.Connector, err error) {
	...
	// Fixing a regression caused by default config fallback: https://github.com/AbnerEarl/sso/provider/issues/2699
