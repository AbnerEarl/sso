...
import (
	...
	"github.com/AbnerEarl/sso/provider/pkg/featureflags"
	"github.com/AbnerEarl/sso/provider/pkg/log"
	"github.com/AbnerEarl/sso/provider/server"
	"github.com/AbnerEarl/sso/provider/storage"
	"github.com/AbnerEarl/sso/provider/storage/ent"
	"github.com/AbnerEarl/sso/provider/storage/etcd"
	"github.com/AbnerEarl/sso/provider/storage/kubernetes"
	"github.com/AbnerEarl/sso/provider/storage/memory"
	"github.com/AbnerEarl/sso/provider/storage/sql"
)
...
// Logger holds configuration required to customize logging for provider.
type Logger struct {
