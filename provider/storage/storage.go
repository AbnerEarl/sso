...
type Client struct {
	...
	// A registered set of redirect URIs. When redirecting from provider to the client, the URI
...
// Connector is an object that contains the metadata about connectors used to login to Provider.
type Connector struct {
	...
	// or making provider reading both tags and act accordingly.
